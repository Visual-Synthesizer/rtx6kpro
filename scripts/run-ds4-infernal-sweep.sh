...
export IMAGE="${IMAGE:-voipmonitor/vllm:infernal-invocation-vllm7ed814e-b12x1bea00c-fi1ac6942-cu133-torch213-20260812-r5}"
export OUT="${OUT:-/root/bench-results/ds4-infernal-invocation-r5-$(date -u +%Y%m%d-%H%M%S)}"
...
export CONTAINER_PREFIX="${CONTAINER_PREFIX:-ds4-infernal-invocation-r5}"
