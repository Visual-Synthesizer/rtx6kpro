...
IMAGE_FLAVOR_TAG="${IMAGE_FLAVOR_TAG:-eldritch-enlightenment-v3}"
VLLM_REF="${VLLM_REF:-fable/dcp-a2a-hybrid-20260707}"
VLLM_COMMIT="${VLLM_COMMIT:-884fe48c429f093544372e8e68a4655a47011e58}"
...
BASE_IMAGE="${BASE_IMAGE:-voipmonitor/vllm:${IMAGE_FLAVOR_TAG}-vllm${VLLM_COMMIT:0:7}-b12x${B12X_COMMIT:0:7}-cu132-${DATE_TAG}-base}"
FINAL_IMAGE="${FINAL_IMAGE:-voipmonitor/vllm:${IMAGE_FLAVOR_TAG}-vllm${VLLM_COMMIT:0:7}-b12x${B12X_COMMIT:0:7}-cu132-${DATE_TAG}}"
