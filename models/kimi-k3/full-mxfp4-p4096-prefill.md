...
| Prompt tokens | August 4 reference | Four MoE launches | Qualified profile | Change from reference | Change from four launches |
|---:|---:|---:|---:|---:|---:|
| 8,192 | 3,450.5 tok/s | 2,723.1 tok/s | 3,857.6 tok/s | +11.80% | +41.66% |
| 32,768 | 3,589.4 tok/s | 2,897.0 tok/s | 3,727.2 tok/s | +3.84% | +28.66% |
| 65,535 | 3,475.2 tok/s | 2,839.7 tok/s | 3,549.5 tok/s | +2.14% | +25.00% |
...
The qualified profile therefore removes the observed 18–21% regression and
exceeds the identified August 4 reference at every measured length.
...
to BF16 once after all routes. For Kimi-K3 at 4,096 tokens per rank, retained
scratch is below approximately 220 MiB: about 112 MiB for the FP32 accumulator,
56 MiB for FC1 cache, and 24 MiB for FC2 cache. Materializing the complete
route output would require approximately 1,014.5 MiB per rank.
...
PR #238 commit    325528adda0a8f0ec88665dfc86e1f008e9058d5
resulting tree    5f9ebc037bd02d33185b23354957543924b5a7e4
```

The patch ID of PR #238 is identical to the patch mounted during runtime
qualification.
...
`5f9ebc037bd02d33185b23354957543924b5a7e4`.
...
| Check | Result |
|---|---|
| B12X W4A16 GPU suite | 221 passed, 16 skipped |
| B12X focused route-reduction group | 54 passed |
...
Two normalized DSpark sanity sets measured 30.320 and 30.451 target cycles per
second. Their emitted medians were 121.54 and 112.98 tok/s because generated
continuations produced different draft acceptance. Target cycles per second,
not emitted token rate, is the decode regression metric for this profile.
