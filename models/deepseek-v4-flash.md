...
| Need | Page |
|---|---|
| Serve DeepSeek-V4-Flash-0731 fixed K5 or DeepSeek-V4-Flash-Vision-Exp fixed K3 | [DeepSeek-V4-Flash Jovian Judgement r4](ds4-jovian-judgement-r4.md) |
...
| Area | Specification |
|---|---|
| Vision checkpoint | `deepseek-ai/DeepSeek-V4-Flash-Vision-Exp`; target-only or fixed probabilistic K3 in Jovian Judgement r4 |
| Qualified DSpark K5 image line | Jovian Judgement r4 for `deepseek-ai/DeepSeek-V4-Flash-0731` |
...
|---|---|---|
| `dev/jovian-judgement` | Jovian Judgement `r*` | [DS4 text and Vision r4](ds4-jovian-judgement-r4.md) |
