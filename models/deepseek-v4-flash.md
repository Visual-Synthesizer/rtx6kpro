...
| Need | Page |
|---|---|
| Serve the 0731 DSpark checkpoint | [DeepSeek-V4-Flash-0731 Infernal Invocation r12](ds4dspark-infernal-invocation-r12.md) |
...
| Area | Specification |
|---|---|
| Recommended image line | Infernal Invocation r12 for `deepseek-ai/DeepSeek-V4-Flash-0731` |
...
|---|---|---|
| `dev/infernal-invocation` | Infernal Invocation `r*` | [Infernal Invocation r12](ds4dspark-infernal-invocation-r12.md) |
