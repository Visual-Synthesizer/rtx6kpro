...
| Area | Specification |
|---|---|
| Recommended image line | Infernal Invocation r18 for `deepseek-ai/DeepSeek-V4-Flash-0731` |
...
|---|---|---|
| `dev/infernal-invocation` | Infernal Invocation `r*` | [Infernal Invocation r18](ds4dspark-infernal-invocation-r18.md) |
