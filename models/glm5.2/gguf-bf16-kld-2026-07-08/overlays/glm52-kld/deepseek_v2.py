        ...
        for name, loaded_weight in weights:
            ...
            for param_name, weight_name, shard_id in stacked_params_mapping:
                ...
                if ".self_attn.indexer." in name and name not in params_dict:
                    # Some GGUF exports carry indexer tensors for every layer,
                    # while vLLM only instantiates indexer modules for layers
                    # that compute top-k under index_topk_pattern.
                    name = None
                    break
                ...
                for j in range(num_chunks):
                    ...
                    for mapping in expert_params_mapping:
                        ...
                        if ".self_attn.indexer." in name and name not in params_dict:
                            # Checkpoint-only indexer tensor for a skipped layer.
                            continue
