# Historical R37 release — DeepSeek-V4.1-Flash
...
The [R37 receipt](qualification.json) identifies the
...
[historical R36 release](../r36/release.md); its C1 client
...
The [registry receipt](registry.json) records the immutable
DockerHub digest, verifies pull-by-digest against the tested image ID and
confirms exactly two layers. The [source lock](source.lock)
