...
| Need | Page |
|---|---|
| Run the current NVFP4 / online FP8-MXFP8 stack | [GLM-5.2 v15](glm5.2_v15.md) |
...
|---|---|
| Primary image line | Fathomless Firmament, documented in [GLM-5.2 v15](glm5.2_v15.md#image-and-model) |
...
| DCP | v15 documents DCP1/2/4/8 and TP6 notes |
...
|---|---|---|
| [GLM-5.2 v15](glm5.2_v15.md) | Current | Latest Fathomless validation and Docker/source pins. |
