...
b12x 0.7.1 adds `--attention-backend b12x` with tuning for all batch sizes, but flashinfer attention remains ~3% faster at c=1 (98.4 vs 95.0 tok/s). Recommended combo: `--attention-backend flashinfer --moe-runner-backend b12x --fp4-gemm-backend b12x`.
