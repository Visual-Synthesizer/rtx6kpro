...
| DS4 serving profile | [DS4 DSpark Infernal Invocation r9](models/ds4dspark-infernal-invocation-r9.md) | 0731 checkpoint, fixed K5, FULL graph dispatch, reasoning-aware strict tool calls, and native CPU KV offload. |
