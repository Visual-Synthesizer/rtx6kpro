...
| DS4 serving profile | [DS4 DSpark Infernal Invocation r15](models/ds4dspark-infernal-invocation-r15.md) | 0731 checkpoint, native inactive-route elimination, fixed K5, FULL graph dispatch, and speculative structured-output validation. |
