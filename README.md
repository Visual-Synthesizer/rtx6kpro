...
| DS4 text and Vision serving profiles | [DeepSeek-V4-Flash Jovian Judgement r4](models/ds4-jovian-judgement-r4.md) | Source-locked TP2 text K5 and Vision K3 serving with GPU KV defaults, one-million-token text direct-LMCache replay, and a 900k-token Vision direct-LMCache profile. |
