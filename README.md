...
| DS4 serving profile | [DS4 DSpark Infernal Invocation r12](models/ds4dspark-infernal-invocation-r12.md) | 0731 checkpoint, fixed K5, FULL graph dispatch, and heterogeneous attention-cache recycling. |
