...
| DS4 serving profile | [DS4 DSpark Infernal Invocation r7](models/ds4dspark-infernal-invocation-r7.md) | 0731 checkpoint, request-state-safe FULL graph dispatch, fixed and confidence-controlled DSpark, concurrent-safe LMCache publication, and native tiered KV offload. |
